...
/**
 * Minimal storage interface so the bot can be run against either:
 *   - Postgres (Prisma) — production
 *   - in-memory Map     — dev / tests
 *
 * The Prisma schema needs to be added at logika/telegram/prisma/schema.prisma
 * alongside the existing backend schema. Keep tables:
