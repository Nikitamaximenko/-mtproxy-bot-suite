...
HELP_GENERAL = (
    ...
    "Подписка привязана к твоему Telegram-аккаунту, а прокси можно включить на любом твоём устройстве (Android/iOS/Telegram Desktop). Лимит по количеству устройств мы не ставим.\n"
    "\n"
    "2) <b>Какие лимиты по трафику?</b>\n"
    "С нашей стороны нет лимита по трафику и мы не режем скорость. Ты используешь Telegram как обычно — без дополнительных ограничений.\n"
    "\n"
