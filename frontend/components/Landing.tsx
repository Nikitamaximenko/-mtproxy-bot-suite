      ...
      <section className="px-5 py-12" style={{ background: "#F7F8FA" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="max-w-2xl mb-8" style={{ fontSize: 16, color: "#4B5563", lineHeight: 1.6 }}>
            Обычный VPN тормозит Wildberries, Сбер и Госуслуги — он гонит весь трафик через заграничный сервер.
            Frosty автоматически разделяет: маркетплейсы, банки, государственные сайты — напрямую;
            Instagram, TikTok, YouTube — через VPN. Без настроек.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                title: "Белые списки",
                text: "WB, Ozon, Avito, Сбер, Т-Банк, Госуслуги, Яндекс, VK, 2ГИС — напрямую. Instagram, TikTok, YouTube — через VPN. Автоматически, без настроек.",
                color: "#2AABEE",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <Faq
              ...
              a="Умный VPN разделяет трафик автоматически. Российские сайты идут напрямую (без VPN и без потери скорости): Wildberries, Ozon, Avito, Lamoda, DNS, Ситилинк, Сбер, Т-Банк, Альфа-Банк, ВТБ, Госуслуги, Яндекс, VK, Mail.ru, 2ГИС, РЖД, Авиасейлс, МТС, Мегафон, Beeline, hh.ru и ещё сотни сайтов. Заблокированные (Instagram, TikTok, YouTube, X, ChatGPT) — автоматически через VPN. Ничего настраивать не нужно."
            />
            <Faq
